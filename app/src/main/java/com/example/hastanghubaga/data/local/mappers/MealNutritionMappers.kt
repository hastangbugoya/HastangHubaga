...
//internal fun com.example.hastanghubaga.data.local.dao.meal.MealNutritionAtTimeRow.toDomain(): com.example.hastanghubaga.domain.model.nutrition.MealNutritionAtTimeRow =
//    com.example.hastanghubaga.domain.model.nutrition.MealNutritionAtTimeRow(
//        timestamp = timestamp,
//        protein = protein,
//        carbs = carbs,
//        fat = fat,
