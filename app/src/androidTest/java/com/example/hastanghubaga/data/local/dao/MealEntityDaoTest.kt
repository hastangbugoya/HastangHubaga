...
import com.example.hastanghubaga.domain.time.DomainTimePolicy as TimePolicy
...
class MealEntityDaoTest {
    ...
    fun getMealsForDate_returnsOnlyThatDate() = runTest {
        ...
        val (y, m, d) = "2025-01-01".split("-").map { it.toInt() }
        val range = TimePolicy.utcMillisRangeForLocalDate(LocalDate(y, m, d))
